...
name: planner
description: >-
  plan fileの品質を保証する。必須項目（受け入れ条件、ベストプラクティス参照、検証手順）の強制、AI自動レビュー、Web検索統合を含む。plan mode開始時、既存planのレビュー時、planテンプレートから下書きを作りたいとき、方針相談・方法論整理時、plan fileの完成度を高めたいときに使う。
---
